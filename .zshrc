...
alias vim='lvim' # If ever need to open nvim just use $ vi
alias vi='nvim'
...
alias snippets='cd ~/.config/lvim/snippets-luasnip-vscode/snippets/javascript-ecosystem/ && vim .'
alias snips='cd ~/.config/lvim/snippets-luasnip-vscode/snippets/javascript-ecosystem/ && vim .'
